...
class Photon {
    constructor(options = {}) {
        ...
        this.datamodel = "datasource db {\n  provider = \"postgresql\"\n  // url      = env(\"POSTGRESQL_URL\")\n  url      = \"postgresql://doadmin:i6x4i2dyl2jc22pb@db-postgresql-sfo2-18129-do-user-3419035-0.db.ondigitalocean.com:25060/getbacon?sslmode=require\"\n}\n\ngenerator photon {\n  provider  = \"photonjs\"\n  // For Lambda (Node 10)\n  platforms = [\"native\", \"linux-glibc-libssl1.0.2\"]\n}\n\ngenerator nexus_prisma {\n  provider = \"nexus-prisma\"\n}\n\nmodel Post {\n  id        String   @default(cuid()) @id @unique\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  published Boolean\n  title     String\n  content   String?\n  author    User?\n}\n\nmodel User {\n  id       String  @default(cuid()) @id @unique\n  email    String  @unique\n  password String\n  name     String?\n  posts    Post[]\n}";
        ...
        this.engine = new runtime_1.Engine({
            ...
            datasources,
            generator: { "name": "photon", "provider": "photonjs", "output": "/Users/brad/code/getBacon/graphql-auth/node_modules/@generated/photon", "platforms": ["native", "linux-glibc-libssl1.0.2"], "pinnedPlatform": null, "config": {} },
            platform: undefined
        });
